...
def main():
    ...
    # Select the network architecture for the requested model.
    ...
    # Resolve or download model weights.
    ...
    total_params = count_parameters(upsampler.model)
    ...
    for idx, path in enumerate(paths):
        if not path.lower().endswith(('.png', '.jpg', '.jpeg', '.tiff', '.bmp', '.webp')):
            continue
